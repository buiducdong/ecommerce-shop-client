...
import { getDetailUser } from '../redux/Actions/UserAction';
import { getListOrder } from '../redux/Actions/OrderAction';
...
const ProfileScreen = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getDetailUser(userInfo?._id));
  }, [dispatch, userInfo]);
  return (
    <>
      <Header />
      <div className='container mt-lg-5 mt-3'>
        <div className='row align-items-start'>
              ...
              <div className='author-card-profile row'>
                ...
                <div className='author-card-details col-md-7'>
                  ...
                  <span className='author-card-position'>
                    <>
                      {userInfo?.name} {userInfo?.createdAt}
                    </>
                  </span>
                </div>
              </div>
          ...
          <div class='tab-content col-lg-8 pb-5 pt-lg-0 pt-3' id='v-pills-tabContent'>
            ...
            >
              <Orders loading={loading} orders={orders} error={error} />
            </div>
          </div>
        </div>
      </div>
